defmodule Calendar.Dekatrian do
  @moduledoc """
  ...
  Elixir expects the extended format by default when parsing:
      iex> Calendar.Dekatrian.parse_naive_datetime("2015-01-23T23:50:07")
      {:ok , {2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("20150123T235007")
      {:error, :invalid_format}
  Parsing can be restricted to basic if desired:
      iex> Calendar.Dekatrian.parse_naive_datetime("20150123T235007Z", :basic)
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("20150123T235007Z", :extended)
      {:error, :invalid_format}
  Only calendar dates are supported in parsing; ordinal and week dates are not.
      iex> Calendar.Dekatrian.parse_date("2015-04-15")
      {:ok, {2015, 4, 15}}
      iex> Calendar.Dekatrian.parse_date("2015-105")
      {:error, :invalid_format}
      iex> Calendar.Dekatrian.parse_date("2015-W16")
      {:error, :invalid_format}
      iex> Calendar.Dekatrian.parse_date("2015-W016-3")
      {:error, :invalid_format}
  Years, months, days, hours, minutes, and seconds must be fully specified:
      iex> Calendar.Dekatrian.parse_date("2015-04-15")
      {:ok, {2015, 4, 15}}
      iex> Calendar.Dekatrian.parse_date("2015-04")
      {:error, :invalid_format}
      iex> Calendar.Dekatrian.parse_date("2015")
      {:error, :invalid_format}
      iex> Calendar.Dekatrian.parse_time("23:50:07.0123456")
      {:ok, {23, 50, 7, {12345, 6}}}
      iex> Calendar.Dekatrian.parse_time("23:50:07")
      {:ok, {23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_time("23:50")
      {:error, :invalid_format}
      iex> Calendar.Dekatrian.parse_time("23")
      {:error, :invalid_format}
  ### Extensions
  ...
  #### Examples
      iex> Calendar.Dekatrian.parse_date("-2015-01-23")
      {:ok, {-2015, 1, 23}}
      iex> Calendar.Dekatrian.parse_date("+2015-01-23")
      {:ok, {2015, 1, 23}}
      iex> Calendar.Dekatrian.parse_naive_datetime("-2015-01-23 23:50:07")
      {:ok, {-2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("+2015-01-23 23:50:07")
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_utc_datetime("-2015-01-23 23:50:07Z")
  ...
  #### Examples
      iex> Calendar.Dekatrian.parse_naive_datetime("2015-01-23 23:50:07.0123456")
      {:ok, {2015, 1, 23, 23, 50, 7, {12345, 6}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("2015-01-23T23:50:07.0123456")
      {:ok, {2015, 1, 23, 23, 50, 7, {12345, 6}}}
      iex> Calendar.Dekatrian.parse_utc_datetime("2015-01-23 23:50:07.0123456Z")
      {:ok, {2015, 1, 23, 23, 50, 7, {12345, 6}}, 0}
      iex> Calendar.Dekatrian.parse_utc_datetime("2015-01-23T23:50:07.0123456Z")
      {:ok, {2015, 1, 23, 23, 50, 7, {12345, 6}}, 0}
  """
  ...
  * [BCE](`t:bce/0`) - for those years less than `1` and is defined as era `0`.
  ...
  defguardp is_month(month) when month in 0..13
  defguardp is_day(day) when day in 1..28
  ...
  ## Examples
      iex> Calendar.Dekatrian.parse_time("23:50:07")
      {:ok, {23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_time("23:50:07Z")
      {:ok, {23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_time("T23:50:07Z")
      {:ok, {23, 50, 7, {0, 0}}}
  """
  @doc since: "1.10.0"
  @impl true
  ...
  module implements [ISO 8601](#module-iso-8601-compliance).
  ## Examples
      iex> Calendar.Dekatrian.parse_time("235007", :basic)
      {:ok, {23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_time("235007", :extended)
      {:error, :invalid_format}
  """
  @doc since: "1.12.0"
  ...
  ## Examples
      ...
      iex> Calendar.Dekatrian.parse_date("2015:01:23")
      {:error, :invalid_format}
      iex> Calendar.Dekatrian.parse_date("2015-01-32")
      {:error, :invalid_date}
  """
  @doc since: "1.10.0"
  @impl true
  ...
  module implements [ISO 8601](#module-iso-8601-compliance).
  ## Examples
      iex> Calendar.Dekatrian.parse_date("20150123", :basic)
      {:ok, {2015, 1, 23}}
      iex> Calendar.Dekatrian.parse_date("20150123", :extended)
      {:error, :invalid_format}
  """
  @doc since: "1.12.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.parse_naive_datetime("2015-01-23 23:50:07")
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("2015-01-23 23:50:07Z")
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("2015-01-23 23:50:07-02:30")
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("2015-01-23 23:50:07.0")
  ...
  module implements [ISO 8601](#module-iso-8601-compliance).
  ## Examples
      iex> Calendar.Dekatrian.parse_naive_datetime("20150123 235007", :basic)
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}}
      iex> Calendar.Dekatrian.parse_naive_datetime("20150123 235007", :extended)
      {:error, :invalid_format}
  """
  @doc since: "1.12.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.parse_utc_datetime("2015-01-23 23:50:07Z")
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}, 0}
      iex> Calendar.Dekatrian.parse_utc_datetime("2015-01-23 23:50:07+02:30")
      {:ok, {2015, 1, 23, 21, 20, 7, {0, 0}}, 9000}
      iex> Calendar.Dekatrian.parse_utc_datetime("2015-01-23 23:50:07")
  ...
  module implements [ISO 8601](#module-iso-8601-compliance).
  ## Examples
      iex> Calendar.Dekatrian.parse_utc_datetime("20150123 235007Z", :basic)
      {:ok, {2015, 1, 23, 23, 50, 7, {0, 0}}, 0}
      iex> Calendar.Dekatrian.parse_utc_datetime("20150123 235007Z", :extended)
      {:error, :invalid_format}
  """
  @doc since: "1.12.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.naive_datetime_to_iso_days(0, 1, 1, 0, 0, 0, {0, 6})
      {0, {0, 86400000000}}
      iex> Calendar.Dekatrian.naive_datetime_to_iso_days(2000, 1, 1, 12, 0, 0, {0, 6})
      {730487, {43200000000, 86400000000}}
      iex> Calendar.Dekatrian.naive_datetime_to_iso_days(2000, 1, 1, 13, 0, 0, {0, 6})
      {730487, {46800000000, 86400000000}}
      iex> Calendar.Dekatrian.naive_datetime_to_iso_days(-1, 1, 1, 0, 0, 0, {0, 6})
      {-364, {0, 86400000000}}
  """
  @doc since: "1.5.0"
  @impl true
  ...
  ## Examples
      iex> Calendar.Dekatrian.naive_datetime_from_iso_days({0, {0, 86400}})
      {0, 0, 1, 0, 0, 0, {0, 6}}
      iex> Calendar.Dekatrian.naive_datetime_from_iso_days({730_485, {0, 86400}})
      {2000, 0, 1, 0, 0, 0, {0, 6}}
      iex> Calendar.Dekatrian.naive_datetime_from_iso_days({730_485, {43200, 86400}})
      {2000, 0, 1, 12, 0, 0, {0, 6}}
      iex> Calendar.Dekatrian.naive_datetime_from_iso_days({-365, {0, 86400000000}})
      {-1, 0, 1, 0, 0, 0, {0, 6}}
  """
  @doc since: "1.5.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.time_to_day_fraction(0, 0, 0, {0, 6})
      {0, 86400000000}
      iex> Calendar.Dekatrian.time_to_day_fraction(12, 34, 56, {123, 6})
  ...
  ## Examples
      iex> Calendar.Dekatrian.time_from_day_fraction({1, 2})
      {12, 0, 0, {0, 6}}
      iex> Calendar.Dekatrian.time_from_day_fraction({13, 24})
      {13, 0, 0, {0, 6}}
  """
  @doc since: "1.5.0"
  @impl true
  ...
  ## Examples
      iex> Calendar.Dekatrian.days_in_month(1900, 1)
      28
      iex> Calendar.Dekatrian.days_in_month(1900, 2)
      28
      iex> Calendar.Dekatrian.days_in_month(2000, 0)
      2
      iex> Calendar.Dekatrian.days_in_month(2001, 0)
      1
      iex> Calendar.Dekatrian.days_in_month(2004, 2)
      28
      iex> Calendar.Dekatrian.days_in_month(2004, 4)
      28
      iex> Calendar.Dekatrian.days_in_month(-1, 5)
      28
  """
  @doc since: "1.4.0"
  @spec days_in_month(year, month) :: 1..28
  @impl true
  def days_in_month(year, month) when is_year(year) and is_month(month) do
    days_in_month_guarded(year, month)
  end

  defp days_in_month_guarded(year, 0) do
    if leap_year?(year), do: 2, else: 1
  end

  defp days_in_month_guarded(_, _), do: 28

  @doc """
  Returns how many months there are in the given year.
  ## Example
      iex> Calendar.Dekatrian.months_in_year(2004)
      13
  """
  @doc since: "1.7.0"
  @impl true
  @spec months_in_year(year) :: 13
  ...
  ## Examples
      iex> Calendar.Dekatrian.leap_year?(2000)
      true
      iex> Calendar.Dekatrian.leap_year?(2001)
      false
      iex> Calendar.Dekatrian.leap_year?(2004)
      true
      iex> Calendar.Dekatrian.leap_year?(1900)
      false
      iex> Calendar.Dekatrian.leap_year?(-4)
      true
  """
  @doc since: "1.3.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.day_of_week(2016, 10, 28, :monday)
      {6, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 1, :monday)
      {7, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 2, :monday)
      {1, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 3, :monday)
      {2, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 4, :monday)
      {3, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 5, :monday)
      {4, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 6, :monday)
      {5, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(-99, 1, 28, :monday)
      {2, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 10, 28, :sunday)
      {7, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 1, :sunday)
      {1, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 2, :sunday)
      {2, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 3, :sunday)
      {3, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 4, :sunday)
      {4, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 5, :sunday)
      {5, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 11, 6, :sunday)
      {6, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(-99, 1, 28, :sunday)
      {3, 1, 7}
      iex> Calendar.Dekatrian.day_of_week(2016, 10, 28, :saturday)
      {1, 1, 7}
  """
  @doc since: "1.11.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.day_of_year(2016, 0, 1)
      1
      iex> Calendar.Dekatrian.day_of_year(2016, 0, 2)
      2
      iex> Calendar.Dekatrian.day_of_year(2016, 1, 28)
      30
      iex> Calendar.Dekatrian.day_of_year(-99, 2, 1)
      30
      iex> Calendar.Dekatrian.day_of_year(2018, 2, 28)
      57
      iex> Calendar.Dekatrian.day_of_year(2020, 2, 28)
      58
  """
  @doc since: "1.8.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.quarter_of_year(2016, 1, 28)
      1
      iex> Calendar.Dekatrian.quarter_of_year(2016, 4, 3)
      2
      iex> Calendar.Dekatrian.quarter_of_year(-99, 9, 28)
      3
      iex> Calendar.Dekatrian.quarter_of_year(2018, 12, 28)
      4
  """
  @doc since: "1.8.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.year_of_era(1)
      {1, 1}
      iex> Calendar.Dekatrian.year_of_era(2018)
      {2018, 1}
      iex> Calendar.Dekatrian.year_of_era(0)
      {1, 0}
      iex> Calendar.Dekatrian.year_of_era(-1)
      {2, 0}
  """
  ...
  ## Examples
      iex> Calendar.Dekatrian.year_of_era(1, 1, 1)
      {1, 1}
      iex> Calendar.Dekatrian.year_of_era(2018, 12, 1)
      {2018, 1}
      iex> Calendar.Dekatrian.year_of_era(0, 1, 1)
      {1, 0}
      iex> Calendar.Dekatrian.year_of_era(-1, 12, 1)
      {2, 0}
  """
  @doc since: "1.13.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.day_of_era(0, 1, 1)
      {366, 0}
      iex> Calendar.Dekatrian.day_of_era(1, 1, 1)
      {2, 1}
      iex> Calendar.Dekatrian.day_of_era(0, 12, 28)
      {29, 0}
      iex> Calendar.Dekatrian.day_of_era(0, 13, 28)
      {1, 0}
      iex> Calendar.Dekatrian.day_of_era(0, 13, 27)
      {2, 0}
      iex> Calendar.Dekatrian.day_of_era(-1, 13, 28)
      {367, 0}
  """
  @doc since: "1.8.0"
  ...
  ## Examples
      iex> Calendar.Dekatrian.time_to_string(2, 2, 2, {2, 6})
      "02:02:02.000002"
      iex> Calendar.Dekatrian.time_to_string(2, 2, 2, {2, 2})
      "02:02:02.00"
      iex> Calendar.Dekatrian.time_to_string(2, 2, 2, {2, 0})
      "02:02:02"
      iex> Calendar.Dekatrian.time_to_string(2, 2, 2, {2, 6}, :basic)
      "020202.000002"
      iex> Calendar.Dekatrian.time_to_string(2, 2, 2, {2, 6}, :extended)
      "02:02:02.000002"
  """
  @impl true
  @doc since: "1.5.0"
  ...
  by passing the `:basic` option.
  ## Examples
      iex> Calendar.Dekatrian.date_to_string(2015, 2, 28)
      "2015-02-28"
      iex> Calendar.Dekatrian.date_to_string(2017, 8, 1)
      "2017-08-01"
      iex> Calendar.Dekatrian.date_to_string(-99, 1, 31)
      "-0099-01-31"
      iex> Calendar.Dekatrian.date_to_string(2015, 2, 28, :basic)
      "20150228"
      iex> Calendar.Dekatrian.date_to_string(-99, 1, 31, :basic)
      "-00990131"
  """
  @doc since: "1.4.0"
  ...
  by passing the `:basic` option.
  ## Examples
      iex> Calendar.Dekatrian.naive_datetime_to_string(2015, 2, 28, 1, 2, 3, {4, 6})
      "2015-02-28 01:02:03.000004"
      iex> Calendar.Dekatrian.naive_datetime_to_string(2017, 8, 1, 1, 2, 3, {4, 5})
      "2017-08-01 01:02:03.00000"
      iex> Calendar.Dekatrian.naive_datetime_to_string(2015, 2, 28, 1, 2, 3, {4, 6}, :basic)
  ...
  ## Examples
      ...
      iex> Calendar.Dekatrian.datetime_to_string(2017, 8, 1, 1, 2, 3, {4, 5}, time_zone, "UTC", 0, 0)
      "2017-08-01 01:02:03.00000Z"
      iex> Calendar.Dekatrian.datetime_to_string(2017, 8, 1, 1, 2, 3, {4, 5}, time_zone, "UTC", 3600, 0)
      "2017-08-01 01:02:03.00000+01:00"
      iex> Calendar.Dekatrian.datetime_to_string(2017, 8, 1, 1, 2, 3, {4, 5}, time_zone, "UTC", 3600, 3600)
      "2017-08-01 01:02:03.00000+02:00"
      iex> time_zone = "Europe/Berlin"
      iex> Calendar.Dekatrian.datetime_to_string(2017, 8, 1, 1, 2, 3, {4, 5}, time_zone, "CET", 3600, 0)
      "2017-08-01 01:02:03.00000+01:00 CET Europe/Berlin"
      iex> Calendar.Dekatrian.datetime_to_string(2017, 8, 1, 1, 2, 3, {4, 5}, time_zone, "CDT", 3600, 3600)
      "2017-08-01 01:02:03.00000+02:00 CDT Europe/Berlin"
      iex> time_zone = "America/Los_Angeles"
      iex> Calendar.Dekatrian.datetime_to_string(2015, 2, 28, 1, 2, 3, {4, 5}, time_zone, "PST", -28800, 0)
      "2015-02-28 01:02:03.00000-08:00 PST America/Los_Angeles"
      iex> Calendar.Dekatrian.datetime_to_string(2015, 2, 28, 1, 2, 3, {4, 5}, time_zone, "PDT", -28800, 3600)
      "2015-02-28 01:02:03.00000-07:00 PDT America/Los_Angeles"
      iex> time_zone = "Europe/Berlin"
      iex> Calendar.Dekatrian.datetime_to_string(2017, 8, 1, 1, 2, 3, {4, 5}, time_zone, "CET", 3600, 0, :basic)
  ...
  ## Examples
      iex> Calendar.Dekatrian.valid_date?(2015, 2, 28)
      true
      iex> Calendar.Dekatrian.valid_date?(2015, 0, 3)
      false
      iex> Calendar.Dekatrian.valid_date?(-1, 12, 28)
      true
      iex> Calendar.Dekatrian.valid_date?(-1, 12, 30)
      false
  """
  @doc since: "1.5.0"
  @impl true
  ...
  @doc """
  Determines if the date given is valid according to the proleptic Gregorian calendar.
  Leap seconds are not supported by the built-in Calendar.Dekatrian.
  ## Examples
      iex> Calendar.Dekatrian.valid_time?(10, 50, 25, {3006, 6})
      true
      iex> Calendar.Dekatrian.valid_time?(23, 59, 60, {0, 0})
      false
      iex> Calendar.Dekatrian.valid_time?(24, 0, 0, {0, 0})
      false
  """
  @doc since: "1.5.0"
  @impl true
  ...
  defp days_before_month(0), do: 0
  defp days_before_month(1), do: 1
  defp days_before_month(2), do: 29
  defp days_before_month(3), do: 57
  defp days_before_month(4), do: 85
  defp days_before_month(5), do: 113
  defp days_before_month(6), do: 169
  defp days_before_month(7), do: 197
  defp days_before_month(8), do: 225
  defp days_before_month(9), do: 253
  defp days_before_month(10), do: 281
  defp days_before_month(11), do: 309
  defp days_before_month(12), do: 309
  defp days_before_month(13), do: 337

  defp leap_day_offset(_year, 0), do: 0
  ...
  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 1 + extra_day do
    {0, day_of_year}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 29 + extra_day do
    {1, day_of_year - (1 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 57 + extra_day do
    {2, day_of_year - (29 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 85 + extra_day do
    {3, day_of_year - (57 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 113 + extra_day do
    {4, day_of_year - (85 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 141 + extra_day do
    {5, day_of_year - (113 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 169 + extra_day do
    {6, day_of_year - (141 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 197 + extra_day do
    {7, day_of_year - (169 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 225 + extra_day do
    {8, day_of_year - (197 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 253 + extra_day do
    {9, day_of_year - (225 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 281 + extra_day do
    {10, day_of_year - (253 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 309 + extra_day do
    {11, day_of_year - (281 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) when day_of_year < 337 + extra_day do
    {12, day_of_year - (309 + extra_day)}
  end

  defp year_day_to_year_date(extra_day, day_of_year) do
    {13, day_of_year - (337 + extra_day)}
  end
